...
public abstract class Guard
{
    ...
    /// <param name="mainFile">application path relative of NetchX\bin</param>
    ...
    protected Guard(string mainFile, bool redirectOutput = true, Encoding? encoding = null)
    {
        ...
        Instance = new Process
        {
            ...
            {
                FileName = fileName,
                WorkingDirectory = $"{Global.NetchXDir}\\bin",
                CreateNoWindow = true,
    ...
    protected string LogPath => Path.Combine(Global.NetchXDir, $"logging\\{Name}.log");
